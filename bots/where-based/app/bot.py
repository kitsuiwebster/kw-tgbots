...
SYSTEM_PROMPT = (
    ...
    "Si plusieurs entités portent ce nom exact, privilégie TOUJOURS l'entité la plus récente et encore active aujourd'hui. "
    "Ignore les entités disparues, rachetées ou devenues inactives. "
    "Si tu mentionnes d'autres entités homonymes, fais-le brièvement à la fin.\n\n"
