...
SYSTEM_PROMPT = (
    ...
    "CRITICAL: If multiple entities exist with the given name, you MUST list ALL of them with the full format for each one, "
    "ordered by global visibility (largest first). Never pick just one and ignore the others.\n"
